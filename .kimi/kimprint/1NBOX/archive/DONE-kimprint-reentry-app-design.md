...
- [ ] Add `conservation_reentry` MCP tool
- [ ] Implement `prepare_rentry_kimprint()` function
- [ ] Add session tracking (`sessions.json`)
- [ ] Implement 3-phase condensation
- [ ] Generate `{{kimprint_dense_explanation}}`
- [ ] Integrate semantic condensation system
- [ ] Add circulari.ty-themed naming
- [ ] Test with real session gaps
