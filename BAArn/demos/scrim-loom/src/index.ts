...
import { scrimHeddles } from './heddles/index.js';
...
export const scrim = {
  ...
  heddles: scrimHeddles,
  
  // Weaver creation
  createWeavvy,
  
  // Divination provider creation
  createDivinationProvider: (config?: import('./divination/index.js').ProviderConfig) => 
    new (await import('./divination/index.js')).DivinationProvider(config),
  
  // Check Three Friends status
  checkFriends: () => ({
    available: true,
    friends: ['🦏 AAAArchi', '🦀 Ferror', '🐋 Orka']
  })
};
